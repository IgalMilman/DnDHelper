...
urlpatterns = [
    ...
    path('<uuid:wikipageuuid>/f/<uuid:wikisectionuuid>/<filename>', wiki_views.wikiSectionFile, name='wiki_section_file'),
    path('<uuid:wikipageuuid>/f/<filename>', wiki_views.wikiPageFile, name='wiki_page_file'),
    path('<uuid:wikipageuuid>/f/<uuid:wikisectionuuid>/', wiki_views.wikiSectionFile, name='wiki_section_file_empty'),
    path('<uuid:wikipageuuid>/f/', wiki_views.wikiPageFile, name='wiki_page_file_empty'),
